...
public class ParOuImpar {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (valor == 0) {
                System.out.println("NULL"); // Zero (nulo)
            } else {
                int calculo = valor % 2;

                if (calculo == 0 && valor > 0) { //Par e Positivo
                    System.out.println("EVEN POSITIVE");
                } else if (calculo == 0 && valor < 0) { //Par e Negativo
                    System.out.println("EVEN NEGATIVE");
                } else if (calculo > 0) { //Ímpar e Positivo
                    System.out.println("ODD POSITIVE");
                } else { //Ímpar e Negativo
